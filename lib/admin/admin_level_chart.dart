...
class LevelChartAdmin extends StatefulWidget {
  const LevelChartAdmin({super.key});

  @override
  State<LevelChartAdmin> createState() => _LevelChartAdminState();
}

class _LevelChartAdminState extends State<LevelChartAdmin> {
  @override
